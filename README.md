...
- **Opera** (14 tools)
  - [`opera_authenticate_mcp_server`](docs/tool-reference.md#opera_authenticate_mcp_server)
  - [`opera_call_mcp_tool`](docs/tool-reference.md#opera_call_mcp_tool)
  - [`opera_chat`](docs/tool-reference.md#opera_chat)
  - [`opera_connect_mcp_server`](docs/tool-reference.md#opera_connect_mcp_server)
  - [`opera_disable_mcp_server`](docs/tool-reference.md#opera_disable_mcp_server)
  - [`opera_do`](docs/tool-reference.md#opera_do)
  - [`opera_enable_mcp_server`](docs/tool-reference.md#opera_enable_mcp_server)
  - [`opera_list_mcp_servers`](docs/tool-reference.md#opera_list_mcp_servers)
  - [`opera_list_mcp_tools`](docs/tool-reference.md#opera_list_mcp_tools)
  - [`opera_list_models`](docs/tool-reference.md#opera_list_models)
  - [`opera_make`](docs/tool-reference.md#opera_make)
  - [`opera_register_mcp_server`](docs/tool-reference.md#opera_register_mcp_server)
  - [`opera_research`](docs/tool-reference.md#opera_research)
  - [`opera_unregister_mcp_server`](docs/tool-reference.md#opera_unregister_mcp_server)
- **Extensions** (5 tools)
